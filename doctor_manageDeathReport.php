...
<?php
    ...
    if (isset($_POST['addDeathReport'])) {// add death report
        ...
        if ($doctor_name && $patient_name && $description && $date) {
            if (if_death_patientName_date_exist($patient_name, $date) === TRUE) {
                $_SESSION['updateError'] = "<div class='updateError'>$patient_name is already death on $date</div>";
            } else {
                if (addNewDeath() === TRUE) {
                    $_SESSION['updateSuccess'] = "<div class='profileSuccess'><strong>$patient_name</strong> Is Added Successful.</div>";
                } else {
                    $_SESSION['updateError'] = "<div class='updateError'><strong>Error While adding new death report.</div>";
                }
            }
        }
    }

    if (isset($_GET['delete'])) {// delete death data
        $id = $_GET['delete'];

        if (deleteDeathAccount($id) === TRUE) { 
            echo "<script>window.location.href='doctor_manageDeathReport.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage Death Report|myBlogsite Hospital</title>
            ...
            <ul id="nav" class="nav sidebar-nav">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation" class="dropActive"><a role="menuitem" tabindex="-1" href="doctor_manageDeathReport.php">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> Manage Death Report</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
    ...
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> Death Report</a></li>
               <li class="departmentTab" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-plus"></i> Add Death Report</a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="departmentAdd">
                    <div class="departmentForm">
                        <form action="doctor_manageDeathReport.php" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="death-doctor" class="control-label col-lg-4">Doctor</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="death-patient" class="control-label col-lg-4">Patient</label>
                                <div class="col-lg-6">
                                    <?php
                            ...
                            <div class="form-group">
                                <label for="death-description" class="control-label col-lg-4">Description</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="death-date" class="control-label col-lg-4">Date</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-4">
                                    <button type="submit" name="addDeathReport" class="btn btn-info">Add Death Report</button>
                                </div>
                            </div><!-- end form-group -->
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/doctor_data/deathFetch.php",
                    type:"post"
                }
            });
        });
