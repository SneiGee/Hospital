...
<?php
    ...
    include('core/accountant_data/updateInfo.php');
                ...
                <div class="tab-pane active fade in" id="departmentList">
                    ...
                    <div class="row editProfileInfo">
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<form action='accountant_profile.php' method='post' class='form-horizontal editProfileInfoForm'>";
                    ...
                    <!-- div class="row changPassword">
                        ...
                        <form action="accountant_profile.php" method="post" class="form-horizontal">
                            <div class="form-group">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="administrator_profile.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
