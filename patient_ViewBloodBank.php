...
<head>    
    ...
    <title>View Blood Bank | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> View Blood Bank</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
    ...
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               ...
               <li class="departmentTab" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-reorder"></i> Blood Donor List</a></li>
            </ul>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/patient_data/bloodBankFetch.php",
                    type:"post"
                }
            });
        });
        ...
        $(document).ready(function() {
            var dataTable = $('#exampleAdd').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/patient_data/bloodDonorFetch.php",
                    type:"post"
                }
            });
        });
