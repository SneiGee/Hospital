                ...
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <div style="width:850px;" class="">
                            <div id="google_translate_element" style="margin-left: 700px; margin-top: 13px"></div>
...
<br>
    <div class="container" id="myblogsite-loginPage">
        ...
        <form class="indexFooterLogin">
            <div class="form-group">
                <span>&copy; 2017 Hospital Management System. All Right Reserved</span><br>
                <span>Developed and Design by <a href="">Schneider Michael</a></span>
            </div>
        </form>
    </div>
