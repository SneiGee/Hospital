...
<head>    
    ...
    <title>View Appoinment | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> View Appoinment</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
    ...
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> View Appointment</a></li>
            </ul>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/administrator_data/appointmentFetch.php",
                    type:"post"
                }
            });
        });
