...
<head>    
    ...
    <title>View Invoice | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> View Invoice</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
...
<br>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/patient_data/addInvoiceFetch.php",
                    type:"post"
                }
            });
        });
    ...
    if (isset($_GET['delete'])) {
        ...
        if ($result_delete) {
            echo "<script>window.location.href='patient_viewInvoice.php'</script>";
        } else {
