...
<?php
    ...
    include('core/guard_data/registertvCamera.php');
    include('core/guard_data/UpdateNewtvCamera.php');
...
<head>    
    ...
    <title>Manage tvCamera | myBlogsite Hospital</title>
    
    <?php include('includes/guardoverall-header.php'); ?>
    
    <link rel="stylesheet" href="css/style/guard/patient_more.css">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> Manage tvCamera</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
...
<br>
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> tvCamera List</a></li>
               <li class="departmentTab" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-plus"></i> Add tvCamera</a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="departmentAdd">
                    <div class="departmentForm">
                        <form action="guard_tvCamera.php" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="guard-tvCamera" class="control-label col-lg-4">Guard Name</label>
                                <div class="col-lg-6">
                                    <?php
                            ...
                            <div class="form-group">
                                <label for="guard-time" class="control-label col-lg-4">Time</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="guard-startweek" class="control-label col-lg-4">Day Start</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="guard-endweek" class="control-label col-lg-4">Day End</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="guard-dateStart" class="control-label col-lg-4">Date Start</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="guard-dateEnd" class="control-label col-lg-4">Date End</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="guard-dateEnd" class="control-label col-lg-4">Status</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-4">
                                   <button type="submit" name="addtvCameraGuard" class="btn btn-info">Add tvCamera Guard</button>
                                </div>
                            </div><!-- end form-group -->
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/guard_data/managetvCameraFetch.php",
                    type:"post"
                }
            });
        });
    ...
    <script> 
        $(document).on('click', '#getEdit', function(e) {
            ...
            $('#content-data').html('');
            $.ajax({
                url: 'core/guard_data/edittvCamera.php',
                type: 'POST',
                data: 'id='+per_id,
                dataType: 'html'
            }).done(function(data) {
    ...
    if (isset($_GET['delete'])) {
        $id = $_GET['delete'];
        $sqldelete = "DELETE FROM tvCamera WHERE id='$id'";
        $result_delete = mysqli_query($conn, $sqldelete);
        if ($result_delete) {
            echo "<script>window.location.href='guard_tvCamera.php'</script>";
        } else {
