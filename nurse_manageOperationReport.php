...
<?php
    ...
    if (isset($_GET['delete'])) {// delete operaion data
        ...
        if (deleteOperationAccount($id) === TRUE) { 
            echo "<script>window.location.href='nurse_manageOperationReport.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage Operation Report | myBlogsite Hospital</title>
        ...
        <div class="sidebar">
            <ul id="nav" class="nav sidebar-nav">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        <li role="presentation" class="dropActive"><a role="menuitem" tabindex="-1" href="nurse_manageOperationReport.php">
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/nurse_data/operationFetch.php",
                    type:"post"
                }
            });
        });
