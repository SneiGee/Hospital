...
<?php
    ...
    if (isset($_POST['addBedAllotment'])) {// add bedAllotment
    ...
    if (isset($_POST['editBedAllotmentData'])) {// update bedAllotment
    ...
    if (isset($_GET['delete'])) {// delete bedAllotment data
        $id = $_GET['delete'];

        if (deleteBedAllotmentAccount($id) === TRUE) { 
            echo "<script>window.location.href='nurse_bedAllotment.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage Bed Allotment | myBlogsite Hospital</title>
            ...
            <ul id="nav" class="nav sidebar-nav">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation" class="dropActive"><a role="menuitem" tabindex="-1" href="nurse_manageBedAllotment.php">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> Manage Bed Allotmnet</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
...
<br>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/nurse_data/bedAllotmentFetch.php",
                    type:"post"
                }
            });
        });
    ...
    <script> 
        $(document).on('click', '#getEdit', function(e) {
            ...
            $('#content-data').html('');
            $.ajax({
                url: 'core/nurse_data/editBedAllotment.php',
                type: 'POST',
                data: 'id='+per_id,
                dataType: 'html'
            }).done(function(data) {
