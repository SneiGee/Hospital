    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="" style="color:#fff">Admin Panel</a></li>
                <li class="dropdown">
                    <a href="#" style="color:#fff" class="dropdown-toggle" data-toggle="dropdown">Account <i class="caret"></i></a>
                    <ul class="dropdown-menu">
                    <li><a href="administrator_profile.php"><i class="fa fa-user"></i> Profile</a></li>
