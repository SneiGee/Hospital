...
<?php
    ...
    if (isset($_GET['delete'])) {// delete other data
        ...
        if (deleteOtherAccount($id) === TRUE) { 
            echo "<script>window.location.href='doctor_manageOtherReport.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage Other Report|myBlogsite Hospital</title>
            ...
            <ul id="nav" class="nav sidebar-nav">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation" class="dropActive"><a role="menuitem" tabindex="-1" href="doctor_manageOtherReport.php">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="departmentAdd">
                    <div class="departmentForm">
                        <form action="doctor_manageOtherReport.php" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label for="other-description" class="control-label col-lg-4">Description</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="other-date" class="control-label col-lg-4">Date</label>
                                <div class="col-lg-6">
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/doctor_data/otherFetch.php",
                    type:"post"
                }
            });
        });
