...
<?php
    ...
    if (isset($_POST['addLaboratory'])) {// add Laboratory
        ...
        if ($name && $email && $password && $address && $phone) {
            if (if_LaboratoryNameExist($name) === TRUE) {
                $_SESSION['updateError'] = "<div class='updateError'>Laboratorist! $name name already exist</div>";
            } else {
                if (if_LaboratoryPhoneExist($phone) === TRUE) {
                    $_SESSION['updateError'] = "<div class='updateError'>Laboratorist! $name name already exist</div>";
                } else {
                    if (addNewLaboratory() === TRUE) {
    ...
    if (isset($_POST['editLaboratoryData'])) { // update Laboratory data
        ...
        if ($name && $email) {
            $updateLaboratoryName_exist = checkUpdateLaboratoryName_exist($id, $name);
            if ($updateLaboratoryName_exist) {
                $_SESSION['updateError'] = "<div class='updateError'>Laboratory! $name already exist</div>";
            } else {
                if (updateLaboratoryData($id) === TRUE) {
                    $_SESSION['updateSuccess'] = "<div class='profileSuccess'>Successfull updated laboratory data</div>";
                } else {
    ...
    if (isset($_GET['delete'])) {
        ...
        if (deleteLaboratoryAccount($id) === TRUE) { // delete Laboratory account
            echo "<script>window.location.href='administrator_laboratory.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage Laboratory | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> Manage Laboratorist</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
...
<br>
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> Laboratorist List</a></li>
               <li class="departmentTab" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-plus"></i> Add Laboratorist</a></li>
            </ul>
                    ...
                    <div class="departmentForm">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="laboratory-name" class="control-label col-lg-4">Laboratorist Name</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="laboratory-email" class="control-label col-lg-4">Email</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="laboratory-password" class="control-label col-lg-4">Password</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="laboratory-address" class="control-label col-lg-4">Address</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="laboratory-phone" class="control-label col-lg-4">Phone</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-4">
                                   <button type="submit" name="addLaboratory" class="btn btn-info">Add Laboratorist</button>
                                </div>
                            </div><!-- end form-group -->
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/administrator_data/laboratoryFetch.php",
                    type:"post"
                }
            });
        });
    ...
    <script> 
        $(document).on('click', '#getEdit', function(e) {
            ...
            $('#content-data').html('');
            $.ajax({
                url: 'core/administrator_data/editLaboratory.php',
                type: 'POST',
                data: 'id='+per_id,
                dataType: 'html'
            }).done(function(data) {
