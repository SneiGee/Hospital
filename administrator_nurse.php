...
<?php
    ...
    if (isset($_POST['addNurse'])) {// add Nurse
        ...
        if ($name && $email && $password && $address && $phone) {
            if (if_NurseNameExist($name) === TRUE) {
                $_SESSION['updateError'] = "<div class='updateError'>Nurse! $name name already exist</div>";
            } else {
                if (if_NursePhoneExist($phone) === TRUE) {
                    $_SESSION['updateError'] = "<div class='updateError'>Nurse! $name name already exist</div>";
                } else {
                    if (addNewNurse() === TRUE) {
    ...
    if (isset($_POST['editNurseData'])) { // update Nurse data
        ...
        if ($name && $email) {
            $updateNurseName_exist = checkUpdateNurseName_exist($id, $name);
            if ($updateNurseName_exist) {
                $_SESSION['updateError'] = "<div class='updateError'>Nurse! $name already exist</div>";
            } else {
                if (updateNurseData($id) === TRUE) {
                    $_SESSION['updateSuccess'] = "<div class='profileSuccess'>Successfull updated nurse data</div>";
                } else {
    ...
    if (isset($_GET['delete'])) { // delete nurse account
        $id = $_GET['delete'];

        if (deleteNurseAccount($id) === TRUE) {
            echo "<script>window.location.href='administrator_nurse.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage Nurse | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> Manage Nurse</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
...
<br>
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> Nurse List</a></li>
               <li class="departmentTab" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-plus"></i> Add Nurse</a></li>
            </ul>
                    ...
                    <div class="departmentForm">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="nurse-name" class="control-label col-lg-4">Nurse Name</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="nurse-email" class="control-label col-lg-4">Email</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="nurse-password" class="control-label col-lg-4">Password</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="nurse-address" class="control-label col-lg-4">Address</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="nurse-phone" class="control-label col-lg-4">Phone</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-4">
                                   <button type="submit" name="addNurse" class="btn btn-info">Add Nurse</button>
                                </div>
                            </div><!-- end form-group -->
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/administrator_data/nurseFetch.php",
                    type:"post"
                }
            });
        });
    ...
    <script> 
        $(document).on('click', '#getEdit', function(e) {
            ...
            $('#content-data').html('');
            $.ajax({
                url: 'core/administrator_data/editnurse.php',
                type: 'POST',
                data: 'id='+per_id,
                dataType: 'html'
            }).done(function(data) {
