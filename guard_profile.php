...
<?php
    ...
    include('core/guard_data/updateInfo.php');
    ...
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> Edit Profile</a></li></a></li>
            </ul>
                ...
                <div class="tab-pane active fade in" id="departmentList">
                    ...
                    <div class="row editProfileInfo">
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                echo "<form action='guard_profile.php' method='post' class='form-horizontal editProfileInfoForm'>";
                    ...
                    <!-- div class="row changPassword">
                        ...
                        <form action="guard_profile.php" method="post" class="form-horizontal">
                            <div class="form-group">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="guard_profile.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
