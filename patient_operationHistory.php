...
<head>    
    ...
    <title>View Admit History | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> View Admit History</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
    ...
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
                <li class="active departmentTabOper" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> Operation</a></li>
                <li class="departmentTabOper" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-reorder"></i> Birth</a></li>
                <li class="departmentTabOper" data-toggle="tab" data-target="#departmentAdd3"><a href="#"><i class="fa fa-reorder"></i> Other</a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                </div><!-- end tab pane for View Operation List  -->
                ...
                <div class="tab-pane fade" id="departmentAdd3">
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/patient_data/operationFetch.php",
                    type:"post"
                }
            });
        });
        $(document).ready(function() {
            var dataTable = $('#example2').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/patient_data/birthFetch.php",
                    type:"post"
                }
            });
        });
        $(document).ready(function() {
            var dataTable = $('#example3').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/patient_data/otherFetch.php",
                    type:"post"
                }
            });
        });
