...
<?php
    ...
    if (isset($_POST['addAccountant'])) {// add Accountant
        ...
        if ($name && $email && $password && $address && $phone) {
            if (if_AccountantNameExist($name) === TRUE) {
                $_SESSION['updateError'] = "<div class='updateError'>Accountant! $name name already exist</div>";
            } else {
                if (if_AccountantPhoneExist($phone) === TRUE) {
                    $_SESSION['updateError'] = "<div class='updateError'>Accountant! $name name already exist</div>";
                } else {
                    if (addNewAccountant() === TRUE) {
    ...
    if (isset($_POST['editAccountantData'])) { // update Accountant data
        ...
        if ($name && $email) {
            $updateAccountantName_exist = checkUpdateAccountantName_exist($id, $name);
            if ($updateAccountantName_exist) {
                $_SESSION['updateError'] = "<div class='updateError'>Accountant! $name already exist</div>";
            } else {
                if (updateAccountantData($id) === TRUE) {
                    $_SESSION['updateSuccess'] = "<div class='profileSuccess'>Successfull updated Accountant data</div>";
                } else {
    ...
    if (isset($_GET['delete'])) {
        ...
        if (deleteAccountantAccount($id) === TRUE) { // delete Laboratory account
            echo "<script>window.location.href='administrator_accountant.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage Accountant | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> Manage Accountant</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
...
<br>
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> Accountant List</a></li>
               <li class="departmentTab" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-plus"></i> Add Accountant</a></li>
            </ul>
                    ...
                    <div class="departmentForm">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="Accountant-name" class="control-label col-lg-4">Accountant Name</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="Accountant-email" class="control-label col-lg-4">Email</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="Accountant-password" class="control-label col-lg-4">Password</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="Accountant-address" class="control-label col-lg-4">Address</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="Accountant-phone" class="control-label col-lg-4">Phone</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-4">
                                   <button type="submit" name="addAccountant" class="btn btn-info">Add Accountant</button>
                                </div>
                            </div><!-- end form-group -->
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/administrator_data/accountantFetch.php",
                    type:"post"
                }
            });
        });
    ...
    <script> 
        $(document).on('click', '#getEdit', function(e) {
            ...
            $('#content-data').html('');
            $.ajax({
                url: 'core/administrator_data/editAccountant.php',
                type: 'POST',
                data: 'id='+per_id,
                dataType: 'html'
            }).done(function(data) {
