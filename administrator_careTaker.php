...
<?php
    ...
    if (isset($_POST['addCareTaker'])) {// add Accountant
        ...
        if ($name && $email && $password && $address && $phone) {
            if (if_CareTakerNameExist($name) === TRUE) {
                $_SESSION['updateError'] = "<div class='updateError'>CareTaker! $name name already exist</div>";
            } else {
                if (if_CareTakerPhoneExist($phone) === TRUE) {
                    $_SESSION['updateError'] = "<div class='updateError'>CareTaker! $name name already exist</div>";
                } else {
                    if (addNewCareTaker() === TRUE) {
    ...
    if (isset($_POST['editCareTakerData'])) { // update Accountant data
        ...
        if ($name && $email) {
            $updateCareTakerName_exist = checkUpdateCareTakerName_exist($id, $name);
            if ($updateCareTakerName_exist) {
                $_SESSION['updateError'] = "<div class='updateError'>CareTaker! $name already exist</div>";
            } else {
                if (updateCareTakerData($id) === TRUE) {
    ...
    if (isset($_GET['delete'])) {
        ...
        if (deleteCareTakerAccount($id) === TRUE) { // delete Laboratory account
            echo "<script>window.location.href='administrator_careTaker.php'</script>";
        } else {
...
<head>    
    ...
    <title>Manage CareTaker | myBlogsite Hospital</title>
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> Manage CareTaker</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
...
<br>
    <div class="container" id="PageContainer">
        <div class="departmentlistTable col-lg-8 col-lg-offset-2">
            <ul class="nav nav-tabs">
               <li class="active departmentTab" data-toggle="tab" data-target="#departmentList"><a href="#"><i class="fa fa-reorder"></i> CareTaker List</a></li>
               <li class="departmentTab" data-toggle="tab" data-target="#departmentAdd"><a href="#"><i class="fa fa-plus"></i> Add CareTaker</a></li>
            </ul>
                    ...
                    <div class="departmentForm">
                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="CareTaker-name" class="control-label col-lg-4">CareTaker Name</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="CareTaker-email" class="control-label col-lg-4">Email</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="CareTaker-password" class="control-label col-lg-4">Password</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="CareTaker-address" class="control-label col-lg-4">Address</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="CareTaker-phone" class="control-label col-lg-4">Phone</label>
                                <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-4">
                                   <button type="submit" name="addCareTaker" class="btn btn-info">Add CareTaker</button>
                                </div>
                            </div><!-- end form-group -->
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/administrator_data/careTakerFetch.php",
                    type:"post"
                }
            });
        });
    ...
    <script> 
        $(document).on('click', '#getEdit', function(e) {
            ...
            $('#content-data').html('');
            $.ajax({
                url: 'core/administrator_data/editCareTaker.php',
                type: 'POST',
                data: 'id='+per_id,
                dataType: 'html'
            }).done(function(data) {
