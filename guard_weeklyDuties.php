...
<?php
    ...
    include('core/guard_data/registerOnDuties.php');
    include('core/guard_data/UpdateNewOnDuties.php');
...
<head>    
    ...
    <title>Manage OnDuties | myBlogsite Hospital</title>
...
<br>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="departmentAdd">
                    <div class="departmentForm">
                        <form action="guard_weeklyDuties.php" method="post" class="form-horizontal" role="form">
                            <div class="form-group">
                                <label for="guard-weeklyDuties" class="control-label col-lg-4">Guard Name</label>
                                <div class="col-lg-6">
                                    <?php
                            ...
                            <div class="form-group">
                                <div class="col-lg-6 col-lg-offset-4">
                                   <button type="submit" name="addOnDuties" class="btn btn-info">Add OnDuties</button>
                                </div>
                            </div><!-- end form-group -->
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/guard_data/manageOnDutiesFetch.php",
                    type:"post"
                }
            });
        });
    ...
    <script> 
        $(document).on('click', '#getEdit', function(e) {
            ...
            $('#content-data').html('');
            $.ajax({
                url: 'core/guard_data/editOnDuties.php',
                type: 'POST',
                data: 'id='+per_id,
                dataType: 'html'
            }).done(function(data) {
    ...
    if (isset($_GET['delete'])) {
        $id = $_GET['delete'];
        $sqldelete = "DELETE FROM onDuties WHERE id='$id'";
        $result_delete = mysqli_query($conn, $sqldelete);
        if ($result_delete) {
            echo "<script>window.location.href='guard_weeklyDuties.php'</script>";
        } else {
