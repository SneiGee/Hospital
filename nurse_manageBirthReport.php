...
<?php
    ...
    if (isset($_GET['delete'])) {// delete birth data
        ...
        if (deleteBirthAccount($id) === TRUE) { 
            echo "<script>window.location.href='nurse_manageBirthReport.php'</script>";
        } else {
            ...
            <ul id="nav" class="nav sidebar-nav">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation" class="dropActive"><a role="menuitem" tabindex="-1" href="nurse_manageBirthReport.php">
                ...
                <div class="tab-pane fade" id="departmentAdd">
                    <div class="departmentForm">
                        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                <label for="birthn-date" class="control-label col-lg-4">Date</label>
                                <div class="col-lg-6">
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/nurse_data/birthFetch.php",
                    type:"post"
                }
            });
        });
