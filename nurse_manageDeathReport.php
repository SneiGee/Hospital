...
<?php
    ...
    if (isset($_GET['delete'])) {// delete death data
        ...
        if (deleteDeathAccount($id) === TRUE) { 
            echo "<script>window.location.href='nurse_manageDeathReport.php'</script>";
        } else {
            ...
            <ul id="nav" class="nav sidebar-nav">
                ...
                <li class="dropdown active">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
                        ...
                        <li role="presentation" class="dropActive"><a role="menuitem" tabindex="-1" href="nurse_manageDeathReport.php">
    ...
    <script>
        $(document).ready(function() {
            var dataTable = $('#example').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    url:"core/nurse_data/deathFetch.php",
                    type:"post"
                }
            });
        });
