...
<head>    
    ...
    <title>careTaker Dashboard|myBlogsite Hospital</title>
    
    <?php include('includes/careTakeroverall-header.php'); ?>
    
    <link rel="stylesheet" href="css/style/careTaker/dashboard.css">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form>
                        <div class="form-group page-header">
                            <h3> <i class="fa fa-info-circle"></i> careTaker Dashboard</h3>
                        </div>
                    </form><!-- end form -->
                </div>
            </div><!-- end row -->
                    ...
                    <div class="form-group">
                        <div class="InfoContent">
                            <?php
                                ...
                                $sql = "SELECT * FROM caretaker WHERE email='".$_SESSION['email']."'";
