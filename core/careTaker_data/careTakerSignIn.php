<?php
    ...
    if (isset($_POST['careTakerLogin'])) {
        ...
        if (empty($email) || empty($password)) {
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                header('location: careTaker_home.php?careTaker-SignIn Success Welcome');
            } else {
    ...
    if (isset($_POST['uploadProfile'])) {
        ...
        $query = mysqli_query($conn, "UPDATE careTaker SET profile = '".$_FILES['file']['name']."' WHERE email = '".$_SESSION['email']."'");
    }
