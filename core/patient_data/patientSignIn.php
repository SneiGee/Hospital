<?php
    ...
    if (isset($_POST['patientLogin'])) {
        ...
        if (empty($email) || empty($password)) {
            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                header('location: patient_home.php?SignIn-Success Welcome');
            } else {
    ...
    if (isset($_POST['uploadProfile'])) {
        ...
        $query = mysqli_query($conn, "UPDATE patients SET profile = '".$_FILES['file']['name']."' WHERE email = '".$_SESSION['email']."'");
    }
