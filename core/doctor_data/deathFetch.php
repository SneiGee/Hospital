...
# ==============================================
  ...
  $request = $_REQUEST;
    ...
    while ($row = mysqli_fetch_array($query)) {
        ...
        $subdata[]='<a href="doctor_manageDeathReport.php?delete='.$row[0].'" onclick="return confirm(\'Are you sure you want to delete this data?\')" class="btn btn-danger btn-sm"><i class="fa fa-trash">&nbsp;</i>Delete</a>';
        $data[]=$subdata;
    }
