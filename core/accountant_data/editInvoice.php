    ...
    <form class="form-horizontal" method="post">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label" for="txtamount">Amount</label>
                            <div class="col-sm-6">
                               <input type="text" class="form-control" id="txtamount" name="txtamount" value="<?php echo $per_amount; ?>">
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="" class="btn btn-info" name="editInvoiceData">Update</button>
            </div>
        </div>
    </form>
<?php
