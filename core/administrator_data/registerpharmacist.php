            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                ...
                if ($resultCheck > 0) {
                    ...
                    if ($resultCheck > 0) {
                        ...
                        # if no error is found save pharmacist info to database
                        ...
                        // print_ Pharmacist inserted successfully
                        $_SESSION['updateSuccess'] = "<div class='profileSuccess'><strong>Pharmacist</strong> $name Is Added Successful</div>";
